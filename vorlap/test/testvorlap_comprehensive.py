...
print(f"compute_thrust_torque_spectrum execution time: {execution_time:.4f} seconds")
...
plt.savefig(f"{figs_dir}/worst_percent_diff.pdf", bbox_inches='tight')
plt.show()
...
plt.ylabel('Inflow (m/s)')
plt.title('Fx')
plt.savefig(f"{figs_dir}/Fx.pdf", bbox_inches='tight')
plt.show()
...
plt.ylabel('Inflow (m/s)')
plt.title('Fy')
plt.savefig(f"{figs_dir}/Fy.pdf", bbox_inches='tight')
plt.show()
...
plt.ylabel('Inflow (m/s)')
plt.title('Fz')
plt.savefig(f"{figs_dir}/Fz.pdf", bbox_inches='tight')
plt.show()
...
plt.ylabel('Inflow (m/s)')
plt.title('Mx')
plt.savefig(f"{figs_dir}/Mx.pdf", bbox_inches='tight')  # Fixed bug from Julia version
plt.show()
...
plt.ylabel('Inflow (m/s)')
plt.title('My')
plt.savefig(f"{figs_dir}/My.pdf", bbox_inches='tight')  # Fixed bug from Julia version
plt.show()
...
plt.ylabel('Inflow (m/s)')
plt.title('Mz')
plt.savefig(f"{figs_dir}/Mz.pdf", bbox_inches='tight')
plt.show()
